		...
		<div className="max-w-3xl mx-auto text-justify">
			...
			<div className = "w-full md:w-3/4 mx-auto my-8">
					...
					<p className = "text-center italic text-neutral-700">
						Looking south from University of Illinois Urbana-Champaign (UIUC) in winter at night. From near to far, Illini Union, Main Quad, Foellinger Auditorium, South Quad, and Bell Tower. Isn't it pretty?
					</p>
			</div>
			...
			<div className="my-8">
				...
				<ul className="list-disc list-inside indent-4 my-4">
					...
					<li>General-purpose computer vision (architectures and optimizations)</li>
